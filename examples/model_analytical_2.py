...
MACHINE1 = Machine(env, id="MACHINE1",node_setup_time=0,work_capacity=1,blocking=True, processing_delay=0.5,in_edge_selection="RANDOM",out_edge_selection="FIRST_AVAILABLE")
MACHINE2 = Machine(env, id="MACHINE2",node_setup_time=0,work_capacity=1,blocking=True, processing_delay=0.3,in_edge_selection="RANDOM",out_edge_selection="FIRST_AVAILABLE")
MACHINE3 = Machine(env, id="MACHINE3",node_setup_time=0,work_capacity=1,blocking=True, processing_delay=0.2,in_edge_selection="RANDOM",out_edge_selection="FIRST_AVAILABLE")
...
BUFFER2 = Buffer(env, id="BUFFER2", capacity=2, delay=0, mode="FIFO")

BUFFER3 = Buffer(env, id="BUFFER3", capacity=2, delay=0, mode="FIFO")
...
BUFFER3.connect(MACHINE2,MACHINE3)
BUFFER4.connect(MACHINE3,SINK)
...
stats_df = pd.DataFrame(stats_rows, columns=["Metric", "FactorySimPy Model"])
stats_df.to_csv("model_analytical_2.csv", index=False)