...
MACHINE1 = Machine(env, id="MACHINE1",node_setup_time=0,work_capacity=1,blocking=True, processing_delay=3,in_edge_selection="RANDOM",out_edge_selection="ROUND_ROBIN")
SINK= Sink(env, id="SINK")

# Initializing edges
BUFFER1 = Buffer(env, id="BUFFER1", capacity=5, delay=100, mode="FIFO")
...
stats_df.to_csv("littleslaw_buffer.csv", index=False)
