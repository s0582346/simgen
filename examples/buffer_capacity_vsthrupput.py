...
MACHINE1 = Machine(env, id="MACHINE1",node_setup_time=0,work_capacity=1,blocking=True, processing_delay=0.5,in_edge_selection="RANDOM",out_edge_selection="ROUND_ROBIN")
...
BUFFER1 = Buffer(env, id="BUFFER1", capacity=10, delay=10, mode="FIFO")
...
stats_df.to_csv("buffer_capacity_vsthrupput.csv", index=False)
