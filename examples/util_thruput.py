...
# Initializing edges
BUFFER1 = Buffer(env, id="BUFFER1", capacity=1000, delay=0, mode="FIFO")
BUFFER2 = Buffer(env, id="BUFFER2", capacity=1000, delay=0, mode="FIFO")
...
stats_df.to_csv("util_thruput.csv", index=False)