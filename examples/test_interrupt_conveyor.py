# Test script to demonstrate interrupt functionality in continuous_conveyor.py
...
MACHINE1 = Machine(env, id="MACHINE1", node_setup_time=0, work_capacity=1, blocking=True, processing_delay=0.5, in_edge_selection="FIRST_AVAILABLE", out_edge_selection="ROUND_ROBIN")
